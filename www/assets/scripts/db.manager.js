    ...
    function dbase() {
        ...
        this.GetTestType = function () {
            ...
            if (window.location.href.indexOf("test_1_") != -1)
                return 13;
            else if (window.location.href.indexOf("test_2_") != -1)
                return 14;
            else if (window.location.href.indexOf("test_3_") != -1)
                return 15;
            else if (window.location.href.indexOf("test_4_") != -1)
                return 9;
            else if (window.location.href.indexOf("test_5_2") != -1)
                return 8;
            else if (window.location.href.indexOf("test_5_3") != -1)
                return 18;
            else if (window.location.href.indexOf("test_6_2") != -1)
                return 2;
            else if (window.location.href.indexOf("test_7_2") != -1)
                return 19;
            else if (window.location.href.indexOf("test_8_2") != -1)
                return 3;
            else if (window.location.href.indexOf("test_9_2") != -1)
                return 4;
            else if (window.location.href.indexOf("test_10_2") != -1)
                return 6;
            else if (window.location.href.indexOf("test_10_3") != -1)
                return 20;
            else if (window.location.href.indexOf("test_11_2") != -1)
                return 7;
            else if (window.location.href.indexOf("test_12_2") != -1)
                return 1;
            else if (window.location.href.indexOf("test_13_2") != -1)
                return 5;
            else if (window.location.href.indexOf("test_13_3") != -1)
                return 16;
            else if (window.location.href.indexOf("test_13_4") != -1)
                return 17;
            else if (window.location.href.indexOf("test_14_2") != -1)
                return 12;
